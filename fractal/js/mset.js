...
var addToPixels = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
	var modulus;
	
	for (var p = 0;p<fractal.pixels.length; p++) {
		modulus = (p+1)%4;
...
var addToPixels2 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
...
var addToPixels3 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
...
var addToPixels4 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels5 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels6 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels7 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels8 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels9 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels10 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels11 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels12 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels13 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var addToPixels14 = function (data) {
	var objId = data.objId;
	var amount = data.amount;
	var fractal = myFractalImages[objId];
  var counter;
...
var startAnimation = function (animationFunctionId,timeout, data) {
  var objId = data.objId;
	...
	switch (animationFunctionId) {
	case 2:
		animationFunction = addToPixels2;
		break;
	case 3:
		animationFunction = addToPixels3;
		break;
	case 4:
		animationFunction = addToPixels4;
		break;
	case 5:
		animationFunction = addToPixels5;
		break;
	case 6:
		animationFunction = addToPixels6;
		break;
	case 7:
		animationFunction = addToPixels7;
		break;
	case 8:
		animationFunction = addToPixels8;
		break;
	case 9:
		animationFunction = addToPixels9;
		break;
	case 10:
		animationFunction = addToPixels10;
		break;
	case 11:
		animationFunction = addToPixels11;
		break;
	case 12:
		animationFunction = addToPixels12;
		break;
	case 13:
		animationFunction = addToPixels13;
		break;
	case 14:
