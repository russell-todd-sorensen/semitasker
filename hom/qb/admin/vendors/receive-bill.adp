...
"
set html "
<form action='receive-bill-2.adp' method='POST' enctype='multipart/form-data'>
<table id='accounts'>
...
<tr>
 ...
 <td><input id='actual_due' name='actual_due' type='date' value='$est_due' /></td>
</tr>
<tr>
...
<tr>
 ...
 <td><input id='received_on' name='received_on' type='date' format='yyyy-mm-dd' value='$received_on' /></td>
</tr>
<tr>
 <th><label for='gap'>Days Until Due</label></th>
 <td><span class='$class'>$gap</span></td>
</tr>
<tr>
...
<tr>
 <th><label for='receive_bill_button'>Receive Bill</label></th>
 <td><input id='receive_bill_button' name='receive_bill_button' type='submit' value='Receive Bill Now'></td>
</tr>"
