			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 0.9375in"/>
						<col style="WIDTH: 2.8229in"/>
						<col style="WIDTH: 1.75in"/>
						<col style="WIDTH: 1.2395in"/>
						<col style="WIDTH: 0.9375in"/>
					...
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>ExtUnique</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ExtContType</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>ExtContEmail</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>ExtContPhone</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="tblExtContInfo">
							<!-- Cache the current node incase the a field is formatted -->
							<xsl:value-of select="fx:CacheCurrentNode(.)"/>
							<tr>
								<td>
									<xsl:value-of select="ExtUnique"/>
								</td>
								<td>
									<xsl:value-of select="ExtContType"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="ExtContEmail"/>
								</td>
								<td>
									<xsl:value-of select="ExtContPhone"/>
								</td>
								<td>
									<xsl:value-of select="Office"/>
								</td>
								<td>
									<xsl:value-of select="ExtContCel"/>
								</td>
								<td>
