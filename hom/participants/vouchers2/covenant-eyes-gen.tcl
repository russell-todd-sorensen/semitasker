...
set csvFileName "hom-covenant-eyes-august-2018-temp.csv"
...
set ceInvoiceFileName "ce-invoices-august.csv"
set cfd [open [file join $dataDirectory $ceInvoiceFileName] r]
...
set invoiceDate "08/01/2018"
set monthNumber 8
set month "Aug"
set monthFull "August"
set year "2018"
set invoiceNumber 1
...
set item_description "Subscription from August 5 to September 5, 2018"
...
foreach participant [lsort [array names CUST]] {
    ...
    if {1} {
        ...
        foreach item $qbName($quotedParticipant) {
        	...
        	set fInvNumber "$month-ce-[format %0.4d $invoiceNumber]"
