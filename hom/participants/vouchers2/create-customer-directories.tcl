...
set imageDirectoryRoot "c:/my-naviserver/semitasker-gh/semitasker/test"
...
foreach participant [lsort [array names CUST]] {
    ...
    if {!$active} {
        ...
        set participantDirectory $tmpName
        
        set letterDirectory [string range $participantDirectory 0 0]
        set houseDirectory [string tolower $house]
        set fullParticipantDir [file join $imageDirectoryRoot $letterDirectory $participantDirectory]
        set fullHouseDir [file join $imageDirectoryRoot houses $houseDirectory $participantDirectory]
        lappend output "create directory $fullParticipantDir"
        lappend output "create directory $fullHouseDir"
        file mkdir $fullParticipantDir
        file mkdir $fullHouseDir
    }
