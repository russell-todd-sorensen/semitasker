...
function solveSudoku() {
	...
	while (AC > 0 && count < MAX_COUNT && solutions < MAX_SOLUTIONS) {
		...
		if ((count % 100000000) == 0) {
			Log("Notice", "Did " + count + " iterations");
...
// For blank puzzleString:
//boxMapString =   "E111111222113332252133433252444433552464455588466758889666758899667778999677778999P0";
puzzleString =     "E003000006007050600006007045700840090290000500040003000000408050800300700000085003P0";
