...
class ImagePuzzle  {
  ...
  constructor () {
    ...
    this.puzzleImage.src = $('#image').val();
    Log.Notice("Image=" + this.puzzleImage.src);
    this.tileDim = $('t#tile-size').val();
    this.puzzleRowsNCols = $('#rows-n-cols').val();
    this.borderWidth = $('#border').val();
    this.randomizeTime = $('#rand-time').val();
    //image, tileMin, rowsTry, colsTry, border

    this.generatePuzzle(this.puzzleImage,
      this.tileDim,
      this.puzzleRowsNCols,
      this.puzzleRowsNCols,
      this.border);
  }
  // (image, tileMin, rowsTry, colsTry, border) BROKEN HERE
