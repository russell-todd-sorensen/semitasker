...
function playHex() {
    ...
    let svg = d3.select("svg"),
        body = d3.select("body"),
        rules = body.select("#rules"),
        player1 = rules.select(".player1"),
        player2 = rules.select(".player2"),
        largeMatrix = new Array(),
        largeMatrixIndex = 0,
        directions =        ["s", "se", "ne", "n", "nw", "sw", "w", "e"],
        directionsRight =   ["center", "ne", "se", "s", "e"],
        specialDirections = ["center", "w", "e", "nnw", "nne", "sse", "ssw"],
        allDirections =     ["n", "ne",  "se", "nw", "s", "sw", "w", "e", "nnw", "nne", "sse", "ssw"],
        innerHexagon, 
        innerInnerHexagon,
        centroid,
        innerCentroid,
