    	...
    	if (this.animateIndex > 360) {
			...
			if (selection[0].length) {
				...
				selection
					...
					.attr(hiliteConfig.endAttrs[Config.style])
					.style(hiliteConfig.endStyles[Config.style])
					.each('end', function(d,i) {
						...
						d3.select(this)
							...
							.ease('linear')
							.delay(function(i) {return i*10})
							.style(hiliteConfig.startStyles[Config.style])
							.attr(hiliteConfig.startAttrs[Config.style]);
					 });
