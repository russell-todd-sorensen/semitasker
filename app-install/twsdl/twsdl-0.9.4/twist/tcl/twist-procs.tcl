...
proc ::twist::install::init { } {
    ...
    variable version [parameter::get_from_package_key -package_key $package -parameter version -default 0.9.4]
...
proc ::twist::install::before-install { } {
    ...
    # Checkout
    exec svn checkout http://twsdl.googlecode.com/svn/tags/$package-$version $versionDirectory
