...
var Customer = {
    ...
    write: function (tmpList,outputSelector,type) {
            ...
            if (type == 'photoOld') {
            	...
            	$(outputSelector)
            		.append(
            			'<iframe class="cust icon-people" src="/hom/participants/images/'
                        + searchString
                        + '" ></iframe>');
            ...
            for (var i = 0;i<tmpSearchList.length;i++) {
                ...
                case 'csv-mike':
                  ...
                  case 'photo':
                   $(outputSelector)
                      .append('<div class="photo" style="background-image: url(\'images/'
                        + customer.firstName 
                        + ' '
                        + customer.lastName
                        + '_edited-1.jpg\');"'
    ...
    searchPhoto: function (inputId, outputSelector) {
    	var searchString = $('#' + inputId).val();
    	$(outputSelector)
            		.html('');
    	$(outputSelector)
            		.append(
            			'<iframe class="photo" src="/hom/participants/images/'
                        + searchString
                        + '" ></iframe>');

    },
    showPhotos: function (inputId, outputSelector) {
